...
#'
#' Mostly for ease of performance benchmarking.
#'
#' A bit crude, only does PCons for simplicity of making it.
#'
...
#'
#' @examples
#' generate_test_files(2010:2015, "Sheffield Central", "E14000919", 2, 3)
generate_test_files <- function(
    years = 3000,
...
#'
#' This function is designed to be used within `generate_test_files` to
...
#' @keywords internal
#'
#' @inheritParams generate_test_files
#'
