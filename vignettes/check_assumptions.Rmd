...
3. Metadata files are checked first, they are fast and can give immediate feedback, plus they are crucial for understanding and checking the data file, so we need to have a passing metadata file before we can test the data file.
