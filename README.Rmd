...
If as a package developer you want to generate larger files for testing with, you can use the `generate_test_files()` functions from `tests/utils/generate_test_files.R` to create files as beefy as you'd like! For example:
...
If you want to go really big, combine with the [dfeR package](https://dfe-analytical-services.github.io/dfeR/), to pass in vectors of Parliamentary Constituencies, the follow example creates an example data and metadata pair with a dataset of just under 6 million rows.
